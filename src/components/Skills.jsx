export default function Skills() {
  return (
    <section className="py-32 bg-[#1c1b1b] text-surface" id="skills">
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          <div className="lg:col-span-4">
            <span className="font-headline uppercase tracking-[0.3em] text-xs text-primary-fixed-dim mb-6 block font-bold">Capabilities</span>
            <h2 className="font-headline font-bold text-5xl mb-8">
              Precision <br />
              <span className="italic font-body font-normal text-surface-variant">Tooling</span>
            </h2>
            <p className="font-body text-lg text-surface-variant/80">
              Proficiency in enterprise-grade platforms to ensure operational transparency and data-driven growth.
            </p>
          </div>
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="p-8 border border-outline-variant/10 rounded group hover:bg-white/5 transition-colors">
              <span className="material-symbols-outlined text-4xl text-primary-fixed-dim mb-6" data-icon="database">
                database
              </span>
              <h4 className="font-headline font-bold text-xl mb-4">Oracle NetSuite (ERP)</h4>
              <p className="font-body text-surface-variant/70">
                Expertise in managing complex enterprise resources, streamlining operations, and ensuring financial accuracy.
              </p>
            </div>
            <div className="p-8 border border-outline-variant/10 rounded group hover:bg-white/5 transition-colors">
              <span className="material-symbols-outlined text-4xl text-primary-fixed-dim mb-6" data-icon="terminal">
                terminal
              </span>
              <h4 className="font-headline font-bold text-xl mb-4">Strategic Workflow</h4>
              <p className="font-body text-surface-variant/70">
                Advanced proficiency in Microsoft Office and Google Workspace for analytical reporting and dynamic presentations.
              </p>
            </div>
            <div className="p-8 border border-outline-variant/10 rounded group hover:bg-white/5 transition-colors">
              <span className="material-symbols-outlined text-4xl text-primary-fixed-dim mb-6" data-icon="groups">
                groups
              </span>
              <h4 className="font-headline font-bold text-xl mb-4">Community &amp; Social</h4>
              <p className="font-body text-surface-variant/70">
                Strategic management of brand presence and community engagement across all major digital ecosystems.
              </p>
            </div>
            <div className="p-8 border border-outline-variant/10 rounded group hover:bg-white/5 transition-colors">
              <span className="material-symbols-outlined text-4xl text-primary-fixed-dim mb-6" data-icon="event_note">
                event_note
              </span>
              <h4 className="font-headline font-bold text-xl mb-4">Event Architecture</h4>
              <p className="font-body text-surface-variant/70">
